...
ruta_archivo_local <- "/home/sanma_ch/buckets/b1/datasets/competencia_02_crudo.csv.gz"
...
fwrite( dataset,
    file =  "competencia_gan_02.csv.gz",
    sep = ","
)
...
cont_bajas <- sum(dfuture[, get("clase_ternaria")] %in% c("BAJA+1", "BAJA+2"))
...
dt_metricas_clave <- data.table(
  ...
  icerca = icerca,
  cont_bajas = cont_bajas,
  gan_normalizada = mcorte_mejor/cont_bajas
)
