...
# Genero el modelo final, siempre sobre TODOS los datos de  final_train, sin hacer ningun tipo de undersampling de la clase mayoritaria y mucho menos cross validation.
  ...
  # d. Guardar el modelo en la lista de resultados
  # Se le da un nombre basado en el índice o la semilla para fácil identificación
  modelos_finales[[paste0("modelo_1_", semilla_actual)]] <- modelo_final
  ...
  #archivo_importancia <- "impo.txt"
  # b. Generar el nombre del archivo dinámicamente
  archivo_importancia <- paste0("impo_1_", semilla_actual, ".txt")
  ...
  # grabo a disco el modelo en un formato para seres humanos ... ponele ...
  lgb.save(modelo_final, "modelo1_.txt" )
  ...
  # grabo las probabilidad del modelo
  fwrite(tb_prediccion,
    file=  paste0("prediccion_1_", semilla_actual, ".txt"),
    sep= "\t"
  )
}
```
...
# Genero el modelo final, siempre sobre TODOS los datos de  final_train, sin hacer ningun tipo de undersampling de la clase mayoritaria y mucho menos cross validation.
  ...
  # d. Guardar el modelo en la lista de resultados
  # Se le da un nombre basado en el índice o la semilla para fácil identificación
  modelos_finales[[paste0("modelo_2_", semilla_actual)]] <- modelo_final
  ...
  #archivo_importancia <- "impo.txt"
  # b. Generar el nombre del archivo dinámicamente
  archivo_importancia <- paste0("impo_2_", semilla_actual, ".txt")
  ...
  # grabo a disco el modelo en un formato para seres humanos ... ponele ...
  lgb.save(modelo_final, "modelo2_.txt" )
  ...
  # grabo las probabilidad del modelo
  fwrite(tb_prediccion,
    file=  paste0("prediccion_2_", semilla_actual, ".txt"),
    sep= "\t"
  )
}
```
...
semillas <- c(378553, 900007, 749987, 499987, 254881)
archivos_a_leer <- paste0("prediccion_", semillas, ".txt")
archivos_a_leer <- paste0("prediccion_1_", semillas, ".txt")
archivos_a_leer <- paste0("prediccion_2_", semillas, ".txt")
