...
MESES_AJUSTE <- generar_rango_meses(201901, 202109)

dt_ajuste <- data.table(
  foto_mes = MESES_AJUSTE,
  factor_ajuste = c(
...
PARAM$train_final$lgbm$param_completo <-  list(
  ...
  num_iterations= 33L, # dejo libre la cantidad de arboles, zLightGBM se detiene solo
...
if( file.exists("prediccion2.txt") )
  file.remove("prediccion2.txt")
